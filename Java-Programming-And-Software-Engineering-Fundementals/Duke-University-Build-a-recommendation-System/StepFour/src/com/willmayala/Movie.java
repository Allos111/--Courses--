...
public class Movie {
    ...
    String aCountry, String aPoster, int theMinutes) {
        // trim() is called just in case data file contains extra whitespace
        id = anID.trim();
        title = aTitle.trim();
        year = Integer.parseInt(aYear.trim());
        genres = theGenres;
    ...
    // A getter method that returns the ID associated with this item
    public String getID () {
        return id;
    }

    // a getter method that returns title of this item
    public String getTitle () {
        return title;
    }

    // A getter method that returns the year in which this item was published
    public int getYear () {
        return year;
    }
    ...
    // Returns a string that contains all the movie's information

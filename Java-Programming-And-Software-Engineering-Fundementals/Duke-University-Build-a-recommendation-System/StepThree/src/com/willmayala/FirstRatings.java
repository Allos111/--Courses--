...
/**
 * This class processes the movie and rating data and answers questions about them.
 * @author Allos111
 */
...
public class FirstRatings
{
	...
	public void testLoadMovies () 
	{
		...
		HashMap<String, Integer> moviesDirectors = new HashMap<String, Integer>(); // To store the director and the count of movies he has
		for (Movie movie : movieData)
		{
	...
	public ArrayList<Rater> loadRaters (String fileName)
	{
		...
		for (CSVRecord record : parser) 
		{
			...
			{ 
				Rater currRater = new EfficientRater(currRaterID);

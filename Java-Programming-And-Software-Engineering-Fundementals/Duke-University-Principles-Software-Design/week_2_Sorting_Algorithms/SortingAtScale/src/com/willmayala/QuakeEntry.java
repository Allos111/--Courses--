...
public class QuakeEntry implements Comparable<QuakeEntry>
{
    ...
    @Override
    public int compareTo(QuakeEntry quakeEntry)
    {
        // if magnitude tie, compare by depth
        if (Double.compare(magnitude, quakeEntry.getMagnitude()) == 0)
        {
            return Double.compare(depth, quakeEntry.getDepth());
        }
        //else, compare by magnitude
        return Double.compare(magnitude, quakeEntry.getMagnitude());
